chrome.runtime.onInstalled.addListener(function(details) {
    if (details.reason == "install") {
      ...
      chrome.storage.sync.set({favorites: ["https://imagizer.imageshack.com/img923/9748/BDp9GP.gif", "https://imagizer.imageshack.com/img922/3831/aOwlGp.gif"]});
      chrome.storage.sync.set({saveLink: "https://imagizer.imageshack.com/img922/3831/aOwlGp.gif"}); //EDIT HERE FOR INITIAL IMAGE
